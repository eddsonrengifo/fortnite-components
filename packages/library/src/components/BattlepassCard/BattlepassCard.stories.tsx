...
const Template: Story<BattlepassCardProps> = (args) => <BattlepassCard {...args} />;

export const Medium = Template.bind({});
Medium.args = {
    rarity: 'dc',
    number: 77,
    image: 'https://media.fortniteapi.io/images/3715149722b1aad7d1837ad3e4432a25/transparent.png'
};
