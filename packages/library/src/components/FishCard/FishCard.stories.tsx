...
export default {
    ...
    argTypes: {
        ...
        image: {
            name: 'Image',
            defaultValue: 'https://media.fortniteapi.io/images/s16_T_Ui_Fish_Flopper_Orange_L.png',
...
Unknown.args = {
    unknown: true,
    number: 14,
    image: 'https://media.fortniteapi.io/images/s16_T_Ui_Fish_Jellyfish_Black_L.png'
};
