...
const LockerCard: React.FC<LockerCardProps> = ({
    ...
    return (
        ...
        >
            ...
            {favorite === true && alert !== true && random !== true && none !== true && (
                <img
                    css={[
            ...
            >
                {animation === true && conflict === true && none !== true && random !== true && (
                    <div
                ...
                {random !== true && none !== true && (
                    <div
                        css={[
                            ...
                            rarity === 'dc' && tw`background[#0992fbf2] border-color[#04a6fa]`,
                            rarity === 'frozenSeries' &&
                            ...
                            rarity === 'epic' && tw`background[#eb82fdf2] border-color[#e381fd]`,
                            rarity === 'rare' && tw`background[#02e7fcf2] border-color[#02ffff]`,
                            rarity === 'uncommon' &&
                                tw`background[#84e40bf2] border-color[#88e41c]`,
                            rarity === 'common' && tw`background[#bebfc3f2] border-color[#C9CFDF]`
                        ]}
                    />
                )}
            </div>
